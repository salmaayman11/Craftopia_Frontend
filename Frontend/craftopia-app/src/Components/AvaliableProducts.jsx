...
const AvaliableProducts = () => {
  ...
  return (
    <section className="py-12 sm:py-20 bg-cream overflow-hidden">
      <div className="container mx-auto px-4 relative">
        ...
        {canScrollLeft && (
          <button
            ...
            className="hidden sm:block absolute -left-6 top-1/2 -translate-y-1/2 z-20 bg-white border border-gray-200 shadow-md rounded-lg p-2 hover:bg-[#fbe9ed] transition touch-manipulation"
          >
        ...
        {canScrollRight && (
          <button
            ...
            className="hidden sm:block absolute -right-6 top-1/2 -translate-y-1/2 z-20 bg-white border border-gray-200 shadow-md rounded-lg p-2 hover:bg-[#fbe9ed] transition touch-manipulation"
          >
        ...
        <motion.div
          ref={scrollRef}
          className="flex gap-4 sm:gap-8 overflow-x-auto px-2 sm:px-5 py-5 scrollbar-hide snap-x snap-mandatory"
          style={{
          ...
          {products.map((product, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group cursor-pointer snap-center w-[280px] sm:w-[300px] md:w-[330px] flex-shrink-0"
              >
                <ProductCard
                  product={product}
